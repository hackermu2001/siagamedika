...
let i=1;function addRowCat(){var t=`
      ...
      `;i++,$(".cat_input").append(t)}function removeRowCat(){var t=$(this).attr("id");$("#row"+t).remove()}$(document).ready(function(){$("#add-row").click(addRowCat),$(document).on("click",".remove-row",removeRowCat),$("#submit_kategori").click(function(){let e=!0;const o=[];$("input[name='txtNamaCat[]']").each(function(){var t,a=$(this).val().trim();return""===a?e=!1:(t=a.toLowerCase(),o.includes(t)?(e=!1,alert("Nama Kategori '"+a+"' sudah ada dalam daftar."),!1):void o.push(t))}),e&&$.ajax({url:"php/function_php/kategori_insert.php",method:"POST",data:$("#add_kategori").serialize(),success:function(t){alert("Selamat data kamu telah berhasil di masukkan"),window.location.reload(),$("#add_kategori")[0].reset(),$(".cat_input tr:not(:first)").remove(),i=0;$(".cat_input tbody").append(`
                      ...
                      `),i++,$("#add-row").click(addRowCat),$(document).on("click",".remove-row",removeRowkategori)}})}),$(document).on("click",".delete-cat",function(){var t=$(this).data("id_cat"),a=$(this).closest("tr");$.ajax({url:"php/function_php/kategori_hapus.php",method:"POST",data:{CatToDelete:t},success:function(t){alert("Data berhasil dihapus"),a.remove(),location.reload()}})}),$(document).on("click",".edit-save-cat",function(){var t,a=$(this).closest("tr"),e=$(this).data("id_cat"),i=a.find(".editable-cell[data-column='NamaKategori']");a.hasClass("editing")?""===(t=i.text().trim())?alert("Nama Kategori tidak boleh kosong"):($.ajax({url:"php/function_php/kategori_update.php",method:"POST",data:{id_catToEdit:e,updatedNamaKategori:t},success:function(t){"Kategori sudah ada di database"===t?alert(t):(alert("Kategori berhasil diperbarui"),location.reload())}}),a.find(".delete-cat").hide()):(a.addClass("editing"),i.attr("contenteditable",!0),$(this).removeClass("btn-primary").addClass("btn-success").html('<i class="fas fa-check"></i>'),a.find(".cancel-edit-cat").show(),a.find(".delete-cat").hide())}),$(document).on("click",".cancel-edit-cat",function(){var t=$(this).closest("tr"),a=(t.removeClass("editing"),t.find(".editable-cell[data-column='NamaKategori']"));a.attr("contenteditable",!1),t.find(".edit-save-cat").removeClass("btn-success").addClass("btn-primary").html('<i class="fas fa-pen"></i>'),$(this).hide(),a.text(a.data("original-value")),t.find(".delete-cat").show()}),$(".cancel-edit-cat").hide()});